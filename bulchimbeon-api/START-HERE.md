...
> **데모 프로젝트**: `fa0445f0-1179-425e-bc2d-33353589b603` (GlobalMart JP Launch)
...
> - 지표: 자동응답률 **0.7561**(목표 0.7) · 🟢 **0.8378**(표본 37) ·
>   🟡 **0.9107**(표본 56) · 🔴 **0.4333**(표본 30) · 절약 대기시간 2232시간
...
>
> ### ⚠️ 🟢 표본은 실행마다 흔들린다 (32~37, 기준 30)
> 30 밑으로 떨어지거나 자동응답률이 목표(0.7)를 밑돌면 **임계값을 내리지 말고**
> `09 §7.2` 의 진단 순서를 따라라 — 🔴 사유별 분포 → 임계값 구간 건수 → 그 질문이 정말
> 답할 수 있는 것인지 → 답할 수 있는데 낮으면 **문안에 주제 앵커를 넣는다.**
> 실제로 8건을 고쳐 자동응답률 0.6829 → 0.7561 이 됐다.
>
> ### 남은 것 (셋 다 외부 입력 대기)
